...
main_buttons = [[
        ...
        InlineKeyboardButton('ᴀᴅᴍɪɴ sᴜᴘᴘᴏʀᴛ', url='https://t.me/RS_Supportz'),
        InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/movie344')
        ],[
...
async def restart(client, message):
    msg = await message.reply_text(
        text="<b><blockquote>If you liked my service ❤</blockquote>\n\n<blockquote>Consider and make support my developer🧑‍💻</blockquote>\n\n<blockquote>We don't need donation if you like our service then share with your friends that is donation for us</blockquote></b>"
        )
